...
<body>
	...
	<div class="container">
		...
		<form action="processAddBook.jsp" name="newBook"
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					...
					<input type="radio" name="condition_Old" value="Old" />
					<fmt:message key="condition_Old" />
					<input type="radio" name="condition_Refurbished" value="Refurebished" />
